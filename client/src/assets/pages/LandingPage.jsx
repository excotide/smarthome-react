  ...
  return (
    <div className="snap-y snap-mandatory h-screen overflow-y-scroll dark:bg-slate-900 dark:text-slate-50 bg-gray-50 font-poppins">
      ...
      <section id="home" className="snap-start">
        <div className="hero grid md:grid-cols-3 h-screen md:justify-between md:items-center">
          <div
            className="hero-content order-2 md:mt-18 md:col-span-2 text-center md:text-left"
          >
            <span className="text-zinc-300/50 sm:text-1xl/tight md:text-3xl/tight">
              Smart Home
            </span>
            <h1 className="font-bold mt-3 md:mt-7 text-2xl md:text-5xl">
      ...
      <section id="about" className="snap-start">
        <div  className="about grid grid-cols-1 md:grid-cols-3 h-screen">
          <div className="col-span-2 order-2 md:order-1 md:mt-7 flex flex-col items-center md:items-end md:justify-center">
            <h2 className="text-2xl md:text-5xl font-bold text-right">Tentang Sistem</h2>
            <span className="text-zinc-300/50 text-center md:text-right sm:text-1xl/tight mt-7 md:text-3xl/tight">Smart Home berbasis IoT</span>
            <p className="mt-7 text-center md:text-right">
            ...
            <div className="mt-7 md:text-right">
              <Button name="Dokumentasi Singkat" link="#project" />
            </div>
          </div>
          <div className="order-1 md:order-2 flex items-center justify-center mt-14">
            <img src="https://picsum.photos/seed/iot/400/400" alt="ilustrasi-iot" className="rounded-3xl w-44 md:w-1/2 shadow-lg"/>
          </div>
        </div>
      </section>
      {/* about */}
      ...
      <section id="project" className="snap-start">
        <div className="project flex flex-col h-screen justify-center px-4">
          <h2 className="text-3xl md:text-5xl font-bold text-center mb-8">Fitur Utama</h2>
          ...
          <div 
            ...
            className="flex gap-4 overflow-x-auto mx-1 snap-x snap-mandatory pb-4 scroll-smooth"
            style={{
      ...
      <section id="contact">
        <div className="contact snap-start h-screen grid">
          <h2 className="text-center mt-28 md:mt-32 font-bold text-3xl md:text-5xl">Kontak & Bantuan</h2>
          ...
          <form action="https://formsubmit.co/d8c13798ebeaf7817534f2b2030e2c3e" method="POST" className="hidden md:flex border-zinc-300 border-2 rounded-3xl lg:w-2/3 mx-auto w-full h-fit">
          ...
          <div className="md:hidden">
            ...
            <div 
              id="social-media"
              className="hidden border-zinc-300 border-2 rounded-3xl p-6 mx-auto w-full max-w-md h-96"
            >
