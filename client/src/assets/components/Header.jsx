import { Home, Sun, X, Moon, Menu, Wifi, LogOut } from 'lucide-react'

const Header = ({ toggleDarkMode, darkMode, sensorData, mobileMenuOpen, setMobileMenuOpen, onLogoutRequest }) => {
  return (
        ...
        <div className="header-content flex justify-between items-center py-4">
          ...
          <div className="header-actions flex items-center gap-4">
            <button
              ...
              className="px-4 py-2 bg-red-500/90 hover:bg-red-600 text-white rounded-lg transition font-medium text-sm flex items-center gap-2"
            >
              <LogOut size={16} />
              Logout
            </button>
